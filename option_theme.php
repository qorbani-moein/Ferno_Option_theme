      ...
      function time_check_frm(){
        ...
        const click_quantity = (id) => {
          ...
          for(var j=0; j <= all_quantity_cart.length ; j++){
            ...
            if(tmp_quantity_cart.length > 0 && tmp_quantity_cart[1] != ""){
              tmp_quantity_cart = tmp_quantity_cart[1].split("</span>");
              document.getElementsByClassName("input-text")[tmp_quantity_cart].value = document.getElementById("quantity_cart_" + j).value;
            }
        ...
        function cart_quantity_product (){
          ...
          var quantity_product_html = `
            <div class="quantity_cart">
                <span class="quantity_cart_plus" onclick="click_quantity(this.id)" id="quantity_cart_plus_nth">+</span>
                <input class="number_quantity_cart" value="0" id="quantity_cart_nth" type="number" name="cart_quantity" min="1" max="10" />
                <span class="quantity_cart_minus" onclick="click_quantity(this.id)" id="quantity_cart_minus_nth">-</span>
            </div>
          `;
